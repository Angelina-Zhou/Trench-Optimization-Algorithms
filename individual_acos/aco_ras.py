...
def ant_colony_optimization(pheromone, fh=False):
    best_solution, best_fitness, fitness_history, variant = aco_funcs.ant_colony_optimization(pheromone, "ras", False)
...
if __name__ == "__main__":
    ...
    shared_vars.plot_fitness_progress(fitness_history, "RAS repaired ACO")
